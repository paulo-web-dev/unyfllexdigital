...
<div class="app" id="admin-app">
 ...
 @can('admin.alunos')
 {{-- Inbox Uazapi — modo sombra, em paralelo ao Chatwoot. Mesmo nível de
      acesso de quem opera o funil (power >= 13). --}}
...
@endcan
@can('admin.social')
<a href="{{ route('admin.social.calendar') }}" class="nav-item {{ request()->routeIs('admin.social.*') ? 'active' : '' }}">
  <svg class="ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
  <span>Instagram</span>
</a>
@endcan
