...
@php
  ...
  $waAjuda     = $waBase . '&text=' . rawurlencode('Olá! Preciso de ajuda para escolher a minissérieideal para o meu cargo.');
...
<section class="section-py" id="minisseries" style="background:var(--bg-1);border-top:1px solid var(--line-1);border-bottom:1px solid var(--line-1);">
  <div class="container">
    <div class="text-center mb-4 aos-fade">
      ...
      <h2 class="section-title">Escolha sua minissériee<br><span class="text-brand-gradient">acesse em 5 minutos</span></h2>
